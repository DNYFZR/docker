...
class carbon_data:
    '''
        Returns the carbon data API output for the last 30 days.
    '''
    def __init__(self, start_date=dt.date(2022, 6, 1), end_date=dt.date(2022,6,3)):
...
if __name__ == '__main__':
    ...
    carbon_data(
        ...
        end_date=dt.date(run_date.year, run_date.month, run_date.day),
        ).run_pipeline()